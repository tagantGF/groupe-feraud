...
<!-- *********** RGPD ******** -->
    ...
    <script type="text/javascript">
        tarteaucitron.init({
    	  "privacyUrl": "https://feraud-color.fr/feraud-peinture-mentions-legales-et-credits", /* Privacy policy url */
        ...
        <div class="container" >
            <div class="row" >
                <div class="col-lg-12 blanc centre" style="text-transform:uppercase; font-size:1.4em; font-weight:200; letter-spacing:1px; padding-top:20em; padding-bottom:10em;" >
	            	Feraud Color est en maintenance,<br /><br />notre nouveau site sera en ligne dès 17h30 !
                </div>
...
<!-- jQuery -->
  ...
  <!-- tarteaucitron -->  
  <script type="text/javascript">
        tarteaucitron.user.gtagUa = 'UA-83528141-1';
