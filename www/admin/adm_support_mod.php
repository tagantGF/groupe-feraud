                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  <h1>Support - Modification</h1>
                
							<?php
							$id_support = $_GET['idct'];
        	                ...
        	                if(isset($_POST['valider'])){
                                ...
                                $sup_nom = (securiseFormulaire(($_POST['sup_nom'])));
								$enligne 	= securiseFormulaire($_POST['enligne']);
								$ordre 		= securiseFormulaire($_POST['ordre']);
                                
                                $enr_support = "UPDATE illi21_support set sup_nom = '$sup_nom', sup_ordre = '$ordre', sup_ol = '$enligne'  WHERE id_s = '$id_support' limit 1;";
								// echo $enr_support;
                                $res_enr_support = mysqli_query($lien, $enr_support) or die ("Erreur : modification support");
            		            ?>
                    		    <p>Le support a bien &eacute;t&eacute; modifi&eacute;.</p>
                            
                        		<p><a href="adm_supports.php" class="lien1">&lt; Gestion des supports</a></p>
                        <?php		
                            }else{
                        ?>
                            <form method="post" action="<?php echo $_SERVER['PHP_SELF']."?idct=$id_support"; ?>" name="aj_famille" id="aj_famille">

                                <div class="mb-3 mt-4 row">
                                    <label for="sup_nom" class="col-sm-3 col-form-label">Libellé : </label>
                                    <div class="col-sm-9">
	                                    <input type="text" name="sup_nom" id="sup_nom" class="form-control" value="<?php echo ($lesupport->sup_nom); ?>" required/>
                                    </div>
                                </div>
                                <div class="mb-3 mt-4 row">
                                    <label for="ordre" class="col-sm-3 col-form-label">Ordre : </label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" name="ordre" id="ordre" size="10" maxlength="3" value="<?php echo $lesupport->sup_ordre; ?>" required/>
                                    </div>
                                 </div>
                                 <div class="mb-3 mt-4 row">
                                    ...
                                    <div class="col-sm-3">
                                        <select name="enligne" id="enligne" class="form-control" required>
                                            <option value="1" <?php if($lesupport->sup_ol == '1') echo 'selected="selected"';?>>Oui</option>
                                            <option value="0" <?php if($lesupport->sup_ol == '0') echo 'selected="selected"';?>>Non</option>
                                        </select>
                                    </div>
                                 </div>
                                ...
                                <div class="mb-3 mt-4 row">   
                                	<div class="col-sm-9">   
                                    <input type="submit" name="valider" id="valider" value="Modifier le support" class="btn btn-success" />
                                    </div>
                                </div>
                            </form>
                        <?php
