            ...
            if(estAuthentifieClient())
            {
                ...
                <div class="container">
                    <div class="row">
						...
						<?php
                            $lect_actualite = "SELECT * FROM illi21_actualites ORDER BY date_pub DESC;";
                            $res_lect_actualite = mysqli_query($lien,$lect_actualite) or die ("Erreur");
                            $nbl = mysqli_num_rows($res_lect_actualite);
							if($nbl > 0)
							{
								while($actualite = mysqli_fetch_object($res_lect_actualite)){
								?>
								<div class="ligne-admin">
									<div class="libelle">
									<?php 
										if($actualite->en_ligne == "1") 
										{
										...
										echo "&nbsp;<img src=\"../images/actualites/alaune/".$actualite->photo_alaune."\" height=\"25px\"> &nbsp;";
										echo substr($actualite->date_pub,8,2)."/".substr($actualite->date_pub,5,2)."/".substr($actualite->date_pub,0,4)." : ".$actualite->titre;
										?>
                                        
									</div>
									<div class="actions">
                                    
                                    	<a href="adm_blog_photos.php?_ida=<?php echo $actualite->id_actu; ?>"><img src="images/administration/picto-camera.png" height="25" alt="gérer les photos supplémentaires" title="gérer les photos supplémentaires" /></a>
										<a href="adm_blog_modif.php?_ida=<?php echo $actualite->id_actu; ?>"><img src="images/administration/picto-modifier.png" height="25" alt="Modifier" title="Modifier" /></a>
										<a href="adm_blog_sup.php?_ida=<?php echo $actualite->id_actu; ?>"><img src="images/administration/picto-supprimer.png" height="25" alt="Supprimer" title="Supprimer" /></a>				</div>
								</div>
								<div class="clear"></div>
								<?php	
								}
							}else{
								echo "<i>Aucune actualité<br><br><br></i>";
							}
							?>
