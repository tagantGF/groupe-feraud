...
<title>Feraud Color- La peinture professionnelle accessible à tous</title>
<meta name="Description" content="Professionnels de la peinture et particuliers, Feraud Color réalise des milliers de teintes sur-mesure dans son laboratoire dédié à la colorimétrie." />
<!-- InstanceEndEditable -->
...
<div class="super_container">
	...
	<div class="pages_internes">
        <div class="container">
        	<div class="row">
            	<div class="col"><h1>Des produits de pros accessibles &agrave; tous</h1></div>
            </div>
            <div class="row">
            	<div class="col-6">
                	<?php
					//Lecture de la page
					$lect_page = "SELECT * FROM illi21_pages WHERE nom_page = 'quoi';";
					$res_lect_page = mysqli_query($lien,$lect_page) or die ("Erreur : page");
					$page = mysqli_fetch_object($res_lect_page);
					echo $page->texte_page; 
					?>
                    <img src="img-yan/nuancier.jpg" alt="" width="475" height="215"/>
                
                </div>
                <div class="col-6">
                	<img src="img-yan/illicolor-aerosol.jpg" alt="Feraud Color aerosol" width="100%"/>
                </div>
            </div>
        </div>
	</div>
