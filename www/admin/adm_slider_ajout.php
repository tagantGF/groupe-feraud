                          ...
                          <!-- InstanceBeginEditable name="EditRegion3" -->
						   <h1>Ajouter un Slide</h1>
                            ...
                            if(isset($_POST['ajouter'])){
                                ...
                                $enr_slider  = "INSERT INTO  illi21_slider ( nomslider, slideimg , lienslide, ord, enligne) ";
                                $enr_slider .= "VALUES ('$libelle', '$imagenm', '$liensclic', '$ord_sous_famille', '$enligne');";
                                $res_enr_slider = mysqli_query($lien,$enr_slider) or die ("Erreur enregistrement Slider");
                                ?>		
                                <p>Le slide a bien été ajouté.</p>
                                <p><a href="adm_slider.php" class="gras">Retour à la gestion des slide</a></p>
                                <?php	
                            }else{
                                // calcule le dernier ordre
                                $lect_dernier = "SELECT ord FROM illi21_slider ORDER BY ord DESC;";
                                ...
                                $dernier = $ledernier->ord + 1;
                                ?>
                                <form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" name="aj_sfam" id="aj_sfam" enctype="multipart/form-data">
                                     <div class="mb-3 mt-4 row">
                                        <label for="libelle" class="col-sm-4 col-form-label">Nom du slide : </label>
                                        <div class="col-sm-8">
	                                        <input type="text" class="form-control" name="libelle" id="libelle" size="60" maxlength="128" required placeholder="128 caractères maxi" />
                                        </div>
                                     </div>
                                     <div class="mb-3 mt-4 row">
                                        <label for="photo2" class="col-sm-4 col-form-label">Image  : </label>
                                        <div class="col-sm-8">
	                                        <input type="file" class="form-control" name="photo2" id="photo2" size="60"  />
                                        </div>
                                     </div>
                                     <div class="mb-3 mt-4 row">
                                        <label for="imgsource" class="col-sm-4 col-form-label"></label>
                                        <div class="col-sm-8">
	                                        <i><strong><img src="images/administration/taille-slider.jpg" /></strong></i>
                                        </div>
                                     </div> 
                                     <div class="mb-3 mt-4 row">
                                        <label for="ordre" class="col-sm-4 col-form-label">Ordre : </label>
                                        <div class="col-sm-4">
	                                        <input type="text" class="form-control" name="ordre" id="ordre" size="10" maxlength="3" value="<?php echo $dernier; ?>" />
                                        </div>
                                     </div>
                                     <div class="mb-3 mt-4 row">
                                        <label for="ordre" class="col-sm-4 col-form-label">Lien au clic sur l'image : </label>
                                        <div class="col-sm-8">
	                                        <input type="text" class="form-control" name="liensclic" id="liensclic"  maxlength="250" value="" />
                                        </div>
                                     </div>
                                     <div class="mb-3 mt-4 row">
                                        <label for="enligne" class="col-sm-4 col-form-label">En ligne : </label>
                                        <div class="col-sm-4">
                                     ...
                                     <div class="mb-3 mt-4 row">
                                        <div class="col-sm-9">
                                        <input type="submit" name="ajouter" id="ajouter" value="Ajouter le slide" class="btn btn-success" />
                                        </div>
                                    </div>
                                </form>  
                                <?php
