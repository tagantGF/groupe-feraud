<?php
	...
	// Lecture des param?tres adresse
...
<div class="super_container">
	...
	<div class="pages_internes">
        <div class="container">
        	<div class="row">
            	<div class="col-sm-12">
            		<h1>Les actualit&eacute;s Feraud Color</h1>
            	</div>
            </div>
        </div>
        <div class="container mt-2">
			<div class="row">
				...
				$req_chantier  = "SELECT tc.id_actu , tc.titre , tc.description , tc.sous_titre, tc.photo_alaune , tc.date_pub, tc.en_ligne  FROM illi21_actualites tc WHERE tc.en_ligne = '1' order by tc.date_pub desc  ";
				$result_chantier = mysqli_query($lien, $req_chantier) or die ("Select 7 impossible");
				$i=0;
				if (mysqli_num_rows($result_chantier)>0)
				{
					 while ($ligne_chantier=mysqli_fetch_object($result_chantier))
					 {
					 	$nomphoto_une = $ligne_chantier->photo_alaune;
						$nom_actualite = $ligne_chantier->titre;
						$ref_chantier = $ligne_chantier->id_actu;
						?>
						<div class="col-md-4 intro_col">                        
                            <div class="ligne_actualite">
                                <div class="actualite_une_img"><a href="feraud-detail-actualites-<?php echo $ref_chantier; ?>"><?php if(is_file("images/actualites/alaune/".$nomphoto_une)) { ?><img src="images/actualites/alaune/<?php echo $nomphoto_une; ?>" alt="Feraud Color - <?php echo $nom_actualite; ?>" title="Feraud Color - <?php echo $nom_actualite; ?>"> <?php } ?></a></div>
                                <div class="actualite_titre"><a href="feraud-detail-actualites-<?php echo $ref_chantier; ?>"><h1><?php echo $nom_actualite; ?></h1></a></div>
                            </div>
                        </div>
						<?php
					 }
