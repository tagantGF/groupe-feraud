                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  <h1>Sous-Familles - Ajout</h1>
							...
							<?php
							$id_s_famille = $_GET['sfamille'];
							$lect_s_famille = "SELECT * FROM illi21_familles_sous WHERE id_sous_famille = '$id_s_famille';";
							$res_lect_s_famillee = mysqli_query($lien,$lect_s_famille) or die ("Erreur : lecture sous famille");
							$sfamille = mysqli_fetch_object($res_lect_s_famillee);
        	                if(isset($_POST['valider'])){
                                ...
                                $enr_s_famille = "UPDATE illi21_familles_sous set sf_famille = '$idfamille', sf_libelle = '$nomsfamille', sf_ordre = '$ordre', sf_enligne =  '$enligne', nomlien = '$lienseo' WHERE id_sous_famille = '$id_s_famille' limit 1;";
                                $res_enr_s_famille = mysqli_query($lien, $enr_s_famille) or die ("Erreur modification sous famille");
            		            ?>
                    		    <p>La sous famille a bien &eacute;t&eacute; modifi&eacute;e.</p>
                        ...
                        ?>
                            <form method="post" action="<?php echo $_SERVER['PHP_SELF']."?sfamille=$id_s_famille"; ?>" name="aj_famille" id="aj_famille">
                                    ...
                                    <select name="idfamille" id="idfamille" required>
                                        <option selected value="">Faire un choix</option>
                                            ...
                                            while($famille = mysqli_fetch_object($res_lect_famille)){
	                                            ?>
                                                        <option value="<?php echo $famille->id_famille; ?>" <?php if($famille->id_famille == $sfamille->sf_famille) echo "selected"; ?> ><?php echo ($famille->f_libelle); ?></option>
    	                                        <?php
                                            }
                                            ?>             
                                    </select>
                                ...
                                <div class="mb-3 mt-4 row">
                                    <label for="nomfamille" class="col-sm-2 col-form-label">Libellé : </label>
                                    <div class="col-sm-10">
	                                    <input type="text" name="nomfamille" id="nomsfamille" class="form-control" value="<?php echo ($sfamille->sf_libelle); ?>" required/>
                                    </div>
                                </div>
                                <div class="mb-3 mt-4 row">
                                    <label for="ordre" class="col-sm-2 col-form-label">Ordre : </label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" name="ordre" id="ordre" size="10" maxlength="3" value="<?php echo $sfamille->sf_ordre; ?>" required/>
                                    </div>
                                 </div>
                                 <div class="mb-3 mt-4 row">
                                    ...
                                    <div class="col-sm-3">
                                        <select name="enligne" id="enligne" class="form-control" required>
                                            <option value="1" <?php if($sfamille->sf_enligne == '1') echo "selected"; ?>>Oui</option>
                                            <option value="0" <?php if($sfamille->sf_enligne == '0') echo "selected"; ?> >Non</option>
                                        </select>
                                    </div>
                                 </div>
                                 <div class="mb-3 mt-4 row">
                                    ...
                                    <div class="col-sm-10">
	                                    <input type="text" name="lienseo" id="lienseo" class="form-control" value="<?php echo $sfamille->nomlien; ?>" maxlength="120"/>
                                    </div>
                                    <div class="col-sm-3"></div>
                                    <div class="col-sm-9">
	                                    <span><i>(pas d'espace, pas de caractères spéciaux, uniquement lettres minuscules et tiret)</i></span>
                                    </div>
                                </div>
                                <div class="mb-3 mt-4 row">   
                                	<div class="col-sm-9">   
                                    <input type="submit" name="valider" id="valider" value="Modifier la sous-famille" class="btn btn-success" />
                                    </div>
                                </div>
                            </form>
                        <?php
