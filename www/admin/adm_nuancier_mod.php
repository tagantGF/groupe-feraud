                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  <h1>Nuancier - Modification</h1>
                
							<?php
							$id_nuancier = $_GET['idct'];
							$lect_nuancier = "SELECT * FROM illi21_nuancier WHERE id_n = '$id_nuancier';";
							$res_lect_nuancier = mysqli_query($lien,$lect_nuancier) or die ("Erreur : lecture nuancier");
							$lenuancier = mysqli_fetch_object($res_lect_nuancier);
        	                if(isset($_POST['valider'])){
                               
                                $nunom = (securiseFormulaire(($_POST['nunom'])));
                                
                                $enr_nuancier = "UPDATE illi21_nuancier set nunom = '$nunom'  WHERE id_n = '$id_nuancier' limit 1;";
								// echo $enr_nuancier;
                                $res_enr_nuancier = mysqli_query($lien, $enr_nuancier) or die ("Erreur : modification nuancier");
            		            ?>
                    		    <p>Le nuancier a bien &eacute;t&eacute; modifi&eacute;.</p>
                            
                        		<p><a href="adm_nuanciers.php" class="lien1">&lt; Gestion des nuanciers</a></p>
                        <?php		
                            }else{
                        ?>
                            <form method="post" action="<?php echo $_SERVER['PHP_SELF']."?idct=$id_nuancier"; ?>" name="aj_famille" id="aj_famille">

                                <div class="mb-3 mt-4 row">
                                    <label for="nunom" class="col-sm-3 col-form-label">Libellé : </label>
                                    <div class="col-sm-9">
	                                    <input type="text" name="nunom" id="nunom" class="form-control" value="<?php echo ($lenuancier->nunom); ?>" required/>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 mt-4 row">   
                                	<div class="col-sm-9">   
                                    <input type="submit" name="valider" id="valider" value="Modifier le nuancier" class="btn btn-success" />
                                    </div>
                                </div>
                            </form>
                        <?php
