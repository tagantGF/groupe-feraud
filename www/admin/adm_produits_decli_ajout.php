                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  <h1>Ajouter une déclinaison</h1>
                           <?php
						   if(isset($_GET['_id_prd']) && is_numeric($_GET['_id_prd']))
							{
								$id_prod = $_GET['_id_prd'];
								if(isset($_POST['ajouter'])){
									...
									$query_ajout_prod  = "INSERT INTO `illi21_produits_var` (`id_prod`, `p_nom`, `p_ref`, `p_prix_ht`, `p_taux_tva`, `p_poids`, `p_enligne`) VALUES (";
									$query_ajout_prod .= "'$id_prod', '$nom_prod', '$ref_prod', '$prix_prod', '1','$pds_prod', '$enligne');";
									// echo $query_ajout_prod;
									$res_enr_prod	= mysqli_query($lien,$query_ajout_prod) or die ("Erreur enregistrement declinaison");
									...
									?>		
									<p>La déclinaison a bien été ajoutée.</p>
								...
								<form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" name="aj_prod" id="aj_prod" enctype="multipart/form-data">
									...
									<div class="mb-3 mt-4 row">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" name="nom_prod" id="nom_prod" maxlength="128" required placeholder="64 caractères maxi (Exemple : 10 litres)" />
										</div>
									 </div>
									<div class="mb-3 mt-4 row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="number" name="pds_prod" id="pds_prod" maxlength="30"  step="0.01"  required class="form-control" placeholder="Kg * (Exemple : 0.95)" />
                                        </div>
                                    </div>
									<div class="mb-3 mt-4 row">
									...
									<div class="mb-3 mt-4 row">
											<div class="col-sm-9">
											<input type="submit" name="ajouter" id="ajouter" value="Ajouter la déclinaison" class="btn btn-success" />
											</div>
										</div>
								</form>
								<?php 
