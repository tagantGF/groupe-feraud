        ...
        <div class="container">
        	<div class="row">
            	<div class="titreh1 text-center">
	            	<h1>R&eacute;initialisation de mon mot de passe</h1>
                </div>
                ...
                <div class="container">
					...
					// DEBUT PARAMETRE OK
						...
						$id_pas = $_GET['_idc'];
						$urldecodee = base64url_decode($id_pas);
						
						// echo $urldecodee;
						$pieces = explode("|", $urldecodee);
						$lecp 	= $pieces[1];
						$lemel1 	= $pieces[3];
						$letemps 	= $pieces[4];
						...
						// DEBUT ENREG TROUVE
							$tmaintenant = time();
							$dif = $tmaintenant - $letemps;
							if($dif < 900)
							{
							// DEBUT VERIF TIMESTAMP
								if(!isset($_POST['valider']))
								{
								// DEBUT FORM ENVOYE
								?>
								  <form role="form" class="needs-validation" novalidate method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>"  >
									<div class="row">
										<div class="form-group col-md-6">
											<label for="exampleInputPassword1">Nouveau mot de passe *</label>
											<input type="password" class="form-control creationcompte" id="exampleInputPassword1" placeholder="Mot de passe (Min. 8 caract&egrave;res et au moins 1 majuscule et 1 chiffre)" required minlength="8" maxlength="24" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" name="pwd1" onchange="form.pwd2.pattern = RegExp.escape(this.value);" >
										</div>
										<div class="form-group col-md-6">
											<label for="exampleInputPassword1">Confirmez le nouveau mot de passe *</label>
											<input type="password" class="form-control creationcompte" id="exampleInputPassword1" placeholder="Confirmation du mot de passe" required minlength="8" maxlength="24" name="pwd2" >
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="form-group col-md-6">
											<input type="submit" class="btn btn-default fondrouge" value="Modifier votre mot de passe" name="valider">
										</div>
									</div>
								</form>
								<?php 
										...
										{
										// DEBUT CODE INCORRECT
											// What happens when the CAPTCHA was entered incorrectly
											echo ("<p class=\"rouge\">Le code entr� est incorrect. Merci de r�essayer.</p><p><a class=\"erreur\" href=\"feraud-peinture-qualite-professionnelle-sur-mesure-couleur-lasure-vernis-bois-metal-personnalisee\">Cliquez ici</a><br><br><br><br><br><br><br><br><br><br><br><br></p>");
										}else{
											// Secon dcontrole si l'adresse mail exite avec le cp
											...
											// DEBUT OK NOUVEAU MOT DE PASSE
												...
												$modifpass = "update illi21_clients_cpt set c_mdp = '$motdepassechiffre' WHERE c_mail= '$lemel1' limit 1;";
												$resultat_lecturepass = mysqli_query($lien,$modifpass) or die ("Erreur : modification mot de passe");
																							
											
												?>
												<p >Votre mot de passe a bien &eacute;t&eacute; modifi&eacute;.<br /><br /><br /> <a href="feraud-mon-compte-mes-commandes">cliquez ici</a> pour vous identifier<br /><br /><br /><br /><br /><br /><br /><br /></p>
												<?php
											}else{
												?>
												<p >Ce compte n'exite pas avec cette adresse courriel et ce code postal.<br /><a href="feraud-peinture-adresse-coordonnees-contact-carte-nous-trouver">Cliquez ici</a> pour vous nous contacter<br /><br /><br /><br /><br /><br /><br /><br /></p>
												<?php
											// FIN OK NOUVEAU MOT DE PASSE
											}
										// FIN CODE INCORRECT
										}
									// FIN FORM ENVOYE
								...
								echo "<p><br><br>Ce lien n'est plus valide ...<br><br><br><br><br><br><br><br></p>";
								// FIN VERIF TIMESTAMP
								}
								
							}else{
							
								echo "<p><br><br>Param�tres incorrects ...<br><br><br><br><br><br><br><br></p>";
							// FIN ENREG TROUVE
							}
