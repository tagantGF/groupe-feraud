                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  <h1>Ajouter une couleur</h1>
							...
							<?php
							if(isset($_GET['_id_cl']) && is_numeric($_GET['_id_cl'])){
								$id_couleur = $_GET['_id_cl'];
								
								$lect_couleur = "SELECT * FROM illi21_couleur WHERE id_cl = '$id_couleur ' limit 1;";
								$res_lect_couleur = mysqli_query($lien,$lect_couleur) or die ("Erreur lecture couleur");
								$lacouleur = mysqli_fetch_object($res_lect_couleur);
								$id_nuancier = $lacouleur->id_nuancier;
								
								if(isset($_POST['modifier'])){
									$coulnom 		= securiseFormulaire($_POST['coulnom']);
									$coulrvb 		= securiseFormulaire($_POST['coulrvb']);
									$typetar 	= securiseFormulaire($_POST['typetar']);
								
									$enr_coule  = "update illi21_couleur set coul_com = '$coulnom', coul_rvb = '$coulrvb',  tartype = '$typetar' WHERE id_cl = '$id_couleur ' limit 1;";
									$res_enr_coule = mysqli_query($lien,$enr_coule) or die ("Erreur enregistrement couleur");
									?>		
									<p>La couleur a bien été modifiée.</p>
									<p><a href="adm_peintures_liste.php?_idnu=<?php echo $id_nuancier; ?>" class="gras">Retour à la liste des couleurs</a></p>
									<?php	
								}else{
									?>
									<form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" name="aj_coul" id="aj_coul">
										<div class="mb-3 mt-4 row">
											<label for="coulnom" class="col-sm-3 col-form-label">Nom : </label>
                                            <div class="col-sm-9">
												<input type="text" name="coulnom" id="coulnom" size="30" maxlength="48" required value="<?php echo $lacouleur->coul_com ;?>" /> (48 caractères maxi. Exemple : RAL1000)
                                            </div>
										</div>
										
										<div class="mb-3 mt-4 row">
											<label for="coulrvb" class="col-sm-3 col-form-label">Valeur Hexadécimale : </label>
                                            <div class="col-sm-9">
												<input type="text" name="coulrvb" id="coulrvb" size="30" maxlength="7" required value="<?php echo $lacouleur->coul_rvb ;?>" /> (7 caractères maxi. Exemple : #BEBD7F)
                                            </div>
										</div>
										<div class="mb-3 mt-4 row">
                                        	<label for="typetar" class="col-sm-3 col-form-label">Type de tarif : </label>
                                            <div class="col-sm-9">
                                            	<div class="form-check">
                                                  <input class="form-check-input" type="radio" name="typetar" id="typetar1" value="100" <?php if($lacouleur->tartype == '100') echo ' checked'; ?>>
                                                  <label class="form-check-label" for="typetar1">
                                                    En stock
                                                  </label>
                                                </div>
                                                <div class="form-check">
                                                  <input class="form-check-input" type="radio" name="typetar" id="typetar2" value="200" <?php if($lacouleur->tartype == '200') echo ' checked'; ?> >
                                                  <label class="form-check-label" for="typetar2">
                                                    Sur mesure
                                                  </label>
                                                </div>
                                            </div>
										...
										<div class="mb-3 mt-4 row">   
                                            <div class="col-sm-9">   
                                            <input type="submit" name="modifier" id="modifier" value="Modifier cette couleur" class="btn btn-success" />
                                            </div>
                                        </div>
									</form>  
									<?php
