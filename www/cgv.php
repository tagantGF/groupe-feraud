...
<title>Feraud Color– La peinture personnalisée accessible à tous</title>
<meta name="Description" content="Feraud Color réalise des milliers de teintes sur-mesure dans son laboratoire dédié à la colorimétrie pour professionnels et particuliers." />
<!-- InstanceEndEditable -->
	...
	<div class="pages_internes dynamiques">
        <div class="container">
        	<div class="row">
            	...
            	<?php
					//Lecture de la page
					$lect_page = "SELECT * FROM illi21_pages WHERE nom_page = 'cgv';";
