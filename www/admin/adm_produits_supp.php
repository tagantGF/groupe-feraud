						  ...
						  <h1>Supprimer un produit</h1>
                            ...
                            if(isset($_GET['id_prd']) && is_numeric($_GET['id_prd']))
                            {
                                ...
                                if(isset($_POST['supprimer'])){
									...
									$sup_declic = "DELETE FROM illi21_produits WHERE id_p = '$id_prod' limit 1;";
                                    $res_sup_declic = mysqli_query($lien,$sup_declic) or die ("Erreur suppression declinaisons");
									
                                    
                                    $sup_produit = "DELETE FROM illi21_produits_var WHERE id_prod = '$id_prod';";
                                    $res_sup_produit = mysqli_query($lien,$sup_produit) or die ("Erreur suppression produit");
                                    ?>		
                                    ...
                                    <form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" name="mod_sfam" id="mod_sfam">
                                        <div class="mb-3 mt-4 row">
                                        	<label for="photo2" class="col-sm-3 col-form-label">Produit à supprimer : </label>
                                            <div class="col-sm-9">
	                                            <strong><?php echo $leproduit->p_nom; ?></strong>
                                            </div>
                                        </div>
                                        <?php 
										if($leproduit->p_type == 'm')
										{
										?>
                                        <div class="mb-3 mt-4 row">
                                        	<label class="col-sm-12 col-form-label">ATTENTION : toutes les déclinaisons seront également supprimées</label>
										...
										?>
                                        <div class="mb-3 mt-4 row">
                                            <label for="photo2" class="col-sm-3 col-form-label"></label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="mb-3 mt-4 row">
                                            <label>&nbsp;</label>
                                            <input type="submit" name="supprimer" class="btn btn-success" id="supprimer" value="Confirmez la suppression de ce produit et de ses photos" />
                                        </div>
                                    </form>  
                                    <?php
                                }
