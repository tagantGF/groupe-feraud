                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  <h1>Gestion des téléchargements</h1>
                          <h2>Documents</h2>
                          
						   <?php
                                $lect_documents = "SELECT * FROM illi21_telechargement where typet = 'd' ORDER BY ordre ASC;";
                                $res_lect_documents = mysqli_query($lien,$lect_documents) or die ("Erreur lecture telechargements");
                                while($lesdocuments = mysqli_fetch_object($res_lect_documents)){
                                ?>
                                    <div class="ligne-admin">
                                        <div class="libelle">&nbsp;&nbsp;&nbsp;<?php echo $lesdocuments->ordre." - ".$lesdocuments->titre; ?></div>
                                        <div class="actions">
                                            <a href="adm_telechargement_mod.php?id_t=<?php echo $lesdocuments->id_t; ?>"><img src="images/administration/picto-modifier.png" height="25" /></a>				
                                            <a href="adm_telechargement_sup.php?id_t=<?php echo $lesdocuments->id_t; ?>"><img src="images/administration/picto-supprimer.png" /></a>
                                        </div>
                                    </div>
                                <?php	
                            	}
                          ...
                          <h2>Vidéos</h2>
                          <?php
                                $lect_documents = "SELECT * FROM illi21_telechargement where typet = 'v' ORDER BY ordre ASC;";
                                $res_lect_documents = mysqli_query($lien,$lect_documents) or die ("Erreur lecture telechargements");
                                while($lesdocuments = mysqli_fetch_object($res_lect_documents)){
                                ?>
                                    <div class="ligne-admin">
