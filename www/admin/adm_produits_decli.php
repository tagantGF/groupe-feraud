						  ...
						  if(isset($_GET['id_prd']) && is_numeric($_GET['id_prd']))
							{
								...
								echo "<h1>Déclinaisons : ".$lenomproduit."</h1>";
								
								?><p><a href="adm_produits_decli_ajout.php?_id_prd=<?php echo $id_prod;?>" class="btn btn-info mb-2">Ajouter une déclinaison</a></p><?php
								...
								if($row_cnt > 0)
								{
									...
									<div class="ligne-admin">
										...
										<div class="actions">
											<a href="adm_produits_decli_modif.php?_id_prd=<?php echo $declinaison->id_decli; ?>" title="Modifier la déclinaisons"><img src="images/administration/picto-modifier.png" height="25" /></a>
											<a href="adm_produits_decli_supp.php?_id_prd=<?php echo $declinaison->id_decli; ?>" title="Supprimer la déclinaisons"><img src="images/administration/picto-supprimer.png" height="25" /></a>
										</div>
									</div>
									<div class="clear"></div>
									<?php	
