<?php
	...
	// Recherche les 3 tarifs
	// Spray 400ml
	$lect_tarifs = "SELECT prixttc FROM illi21_tarifspdr where idp_contenant = '25500' limit 1";
	...
	if($row_cnt > 0)
	{
		...
		$tarif25500 = $tarifcla->prixttc;
	}else{
		$tarif25500 = "1000";
	}
	
	// Flacon retouche 15 ml
	$lect_tarifs = "SELECT prixttc FROM illi21_tarifspdr where idp_contenant = '25600' limit 1";
	$res_lect_tarifs = mysqli_query($lien, $lect_tarifs) or die ("Erreur lecture tarifs mesure");
	$row_cnt = mysqli_num_rows($res_lect_tarifs);
	if($row_cnt > 0)
	{
		$tarifcla = mysqli_fetch_object($res_lect_tarifs);
		$tarif25600 = $tarifcla->prixttc;
	}else{
		$tarif25600 = "1000";
	}
	
	// Lot de 6 feutres de 8ml
	$lect_tarifs = "SELECT prixttc FROM illi21_tarifspdr where idp_contenant = '25800' limit 1";
	$res_lect_tarifs = mysqli_query($lien, $lect_tarifs) or die ("Erreur lecture tarifs mesure");
	$row_cnt = mysqli_num_rows($res_lect_tarifs);
	if($row_cnt > 0)
	{
		$tarifcla = mysqli_fetch_object($res_lect_tarifs);
		$tarif25800 = $tarifcla->prixttc;
	}else{
		$tarif25800 = "1000";
	}
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  <h1>Tarif de base des poudres HT</h1>
                          <?php
                          if(isset($_POST['modifier']))
						  {
							  $tar_25500 	= securiseFormulaire($_POST['tar25500']);
							  $tar_25600	= securiseFormulaire($_POST['tar25600']);
							  $tar_25800	= securiseFormulaire($_POST['tar25800']);
							  
							  if ($tar_25500 > 0 and $tar_25600 > 0 and $tar_25800 > 0)
							  {
							  	$maj_tarif  = "UPDATE illi21_tarifspdr SET prixttc = '$tar_25500' WHERE idp_contenant = '25500' limit 1;"; // 
								$res_maj_tarif = mysqli_query($lien, $maj_tarif) or die ("Erreur modification tarifs poudre 25500");	
								
								$maj_tarif  = "UPDATE illi21_tarifspdr SET prixttc = '$tar_25600' WHERE idp_contenant = '25600' limit 1;"; // 
								$res_maj_tarif = mysqli_query($lien, $maj_tarif) or die ("Erreur modification tarifs poudre 25600");
								
								$maj_tarif  = "UPDATE illi21_tarifspdr SET prixttc = '$tar_25800' WHERE idp_contenant = '25800' limit 1;"; // 
								$res_maj_tarif = mysqli_query($lien, $maj_tarif) or die ("Erreur modification tarifs poudre 25800");	 
							  
							  	echo "<br>Les tarifs des poudres ont bien été modifiés ...<br>";
							  }else{
							  	echo "<br>Les tarifs des poudres n'ont pas été modifiés car l'un des nombres était à 0 ...<br>";
							  }
                          }else{
						  ?>
						  	<form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" name="recgesprod" id="recgesprod">
                                <div class="mb-3 mt-4 row">
                                	...
                                	<div class="col-sm-2">
		                                <input type="text" class="form-control" name="tar25500" id="inputclassique" value="<?php echo $tarif25500; ?>"  >
        	                        </div>
                                </div>
            
                                <div class="mb-3 row">
            	                    <label for="inputPassword" class="col-sm-4 col-form-label">Flacon retouche 15 ml)</label>
                	                <div class="col-sm-2">
                    		            <input type="text" class="form-control" id="inputmesure"  name="tar25600" value="<?php echo $tarif25600; ?>">
                            	    </div>
                                </div>
                                <div class="mb-3 row">
            	                    <label for="inputPassword" class="col-sm-4 col-form-label">Lot de 6 feutres de 8ml</label>
                	                <div class="col-sm-2">
                    		            <input type="text" class="form-control" id="inputmesure"  name="tar25800" value="<?php echo $tarif25800; ?>">
                            	    </div>
                                </div>
                                <div class="mb-3 row">
