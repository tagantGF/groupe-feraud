                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  <h1>Les contenants</h1>
                        
                    <?php
                    $lect_contenant = "SELECT * FROM illi21_contenant ORDER BY cont_ordre ASC;";
                    $res_lect_contenant = mysqli_query($lien,$lect_contenant) or die ("Erreur");
                    while($contenant = mysqli_fetch_object($res_lect_contenant)){
                    ?>
                    <div class="ligne-admin">
                        <div class="libelle"><?php echo $contenant->cont_ordre." - ".$contenant->cont_nom;?></div>
                        <div class="actions">
                            <a href="adm_contenant_mod.php?idct=<?php echo $contenant->id_c; ?>"><img src="images/administration/picto-modifier.png" width="25" /></a>
                        </div>
                    </div>
                    <div class="clear"></div>
                    <?php	
