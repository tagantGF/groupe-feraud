                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  <h1>Supprimer un code promos</h1>
						  ...
						  if(isset($_GET['cpr']) && is_numeric($_GET['cpr'])){
                            ...
                            if(isset($_POST['supprimer']))
							{
								...
								$sup_code_promo  = "delete from illi21_promo  WHERE id_promo = '$id_cpr' limit 1;";
								$res_sup_code_promo = mysqli_query($lien,$sup_code_promo) or die ("Erreur suppression code promo");
								?>		
									<p>Le code a bien été supprimé.</p>
                                ...
                                <form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" name="aj_sfam" id="aj_sfam">
                                    <div class="mb-3 mt-4 row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" disabled value="<?php echo $code_promo->code_promo ;?>" />
                                        </div>
                                    </div>
                                    <?php if( $code_promo->promo_mttc > 0) {?>
                                    <div class="mb-3 mt-12 row">
                                        <label for="libelle" class="col-sm-2 col-form-label">Montant € : </label>
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" disabled value="<?php echo $code_promo->promo_mttc ;?>" />
                                        </div>
                                        
                                    </div>
                                        
                                    <?php } ?>
                                    <?php if( $code_promo->promo_pourc > 0) {?>
                                    <div class="mb-3 mt-12 row">
                                        
                                        <label for="libelle" class="col-sm-2 col-form-label">Remise % : </label>
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" disabled  value="<?php echo $code_promo->promo_pourc ;?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 mt-4 row">
                                        <div class="col-sm-9">
                                        <input type="submit" name="supprimer" id="supprimer" value="Supprimer le code" class="btn btn-success" />
                                        </div>
                                    </div>
                                </form>  
                                <?php
