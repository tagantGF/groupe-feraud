                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  <h1>Codes Promo</h1>
						   <?php
                                $lect_cpromos = "SELECT * FROM illi21_promo ORDER BY id_promo ASC;";
                                $res_lect_cpromos = mysqli_query($lien,$lect_cpromos) or die ("Erreur lecture codes promo");
								$row_cnt = mysqli_num_rows($res_lect_cpromos);
								if($row_cnt > 0)
								{
									
									while($lescodes = mysqli_fetch_object($res_lect_cpromos)){
										?>
										<div class="ligne-admin">
											...
											echo $lescodes->code_promo." : ";
											if ($lescodes->promo_pourc > 0) echo $lescodes->promo_pourc."<strong> %</strong>"; 
											if ($lescodes->promo_mttc > 0) echo $lescodes->promo_mttc."<b> €</b>"; 
											if ($lescodes->cadeau == '1') echo " Cadeau"; 
											?>
											</div>
											<div class="actions">
												<a href="adm_promos_modif.php?cpr=<?php echo $lescodes->id_promo; ?>"><img src="images/administration/picto-modifier.png" height="25" /></a>				
												<a href="adm_promos_supp.php?cpr=<?php echo $lescodes->id_promo; ?>"><img src="images/administration/picto-supprimer.png" /></a>
											</div>
										</div>
										<div class="clear"></div>
										<?php	
									...
									echo "<i>Aucun code promo ...</i>";
								}
                             ?>
                            
                            <div class="legendeadmin">
                                <span style="color:#00b100">&nbsp;&nbsp;&nbsp;<strong><sup>&#9632;</sup></strong> <i style="color:#333333">Actif</i></span>
                                <span style="color:#d70303"><br />&nbsp;&nbsp;&nbsp;<strong><sup>&#9632;</sup></strong> <i style="color:#333333">Désactivé</i></span>
                            </div>
