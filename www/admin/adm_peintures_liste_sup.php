						  ...
						  <h1>Supprimer une couleur</h1>
							...
							if(isset($_GET['_id_cl']) && is_numeric($_GET['_id_cl'])){
								...
								if(isset($_POST['supprimer'])){
									...
									$sup_coule  = "delete from illi21_couleur WHERE id_cl = '$id_couleur ' limit 1;";
									$res_sup_coule = mysqli_query($lien,$sup_coule) or die ("Erreur suppression couleur");
									?>		
									<p>La couleur a bien été suprimée.</p>
									...
									<form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" name="aj_coul" id="aj_coul">
										<div class="mb-3 mt-4 row">
                                            ...
                                            <div class="col-sm-9">
												<input type="text" name="coulnom" id="coulnom" size="30" maxlength="48" disabled value="<?php echo $lacouleur->coul_com ;?>" /> 
                                            </div>
										</div>
										...
										<div class="mb-3 mt-4 row">
                                            ...
                                            <div class="col-sm-9">
												<input type="text" name="coulrvb" id="coulrvb" size="30" maxlength="7" disabled value="<?php echo $lacouleur->coul_rvb ;?>" /> (7 caractères maxi. Exemple : #BEBD7F)
                                            </div>
										</div>
										...
										<div class="mb-3 mt-4 row">   
                                            <div class="col-sm-9">   
                                            <input type="submit" name="supprimer" id="supprimer" value="CONFIRMER la suppression de cette couleur" class="btn btn-success" />
                                            </div>
                                        </div>
									</form>  
									<?php
