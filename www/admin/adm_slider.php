                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  <h1>Slider</h1>
						   <?php
                                $lect_sliders = "SELECT * FROM illi21_slider ORDER BY ord ASC;";
                                $res_lect_sliders = mysqli_query($lien,$lect_sliders) or die ("Erreur lecture slider");
                                while($lesliders = mysqli_fetch_object($res_lect_sliders)){
                                ?>
                                <div class="ligne-admin">
                                    <div class="libelle">
                                    <?php 
                                    if($lesliders->enligne == "1") 
                                    {
                                    ...
                                    ?>
                                    &nbsp;&nbsp;&nbsp;<?php echo $lesliders->ord." - ".$lesliders->nomslider; ?></div>
                                    <div class="actions">
                                        <a href="adm_slider_mod.php?id_s=<?php echo $lesliders->id_sf; ?>"><img src="images/administration/picto-modifier.png" height="25" /></a>				
                                        <a href="adm_slider_sup.php?id_s=<?php echo $lesliders->id_sf; ?>"><img src="images/administration/picto-supprimer.png" /></a>
                                    </div>
                                </div>
                                <div class="clear"></div>
                                <?php	
