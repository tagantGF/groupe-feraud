                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  <h1>Import de fichier CSV dans la base produits</h1>
                          	...
                          	<p>Le fichier d'import des PRODUITS au format CSV  doit contenir les colonnes suivantes : <br />- A : Nom du produits<br />- B : Référence produit<br />- C : Famille (Suivant liste)<br />- D : Sous-Famille (Suivant liste)<br />- E : Descriptif commercial<br />- F : Descriptif technique<br />- G : Prix unitaire HT<br />- H : Poids<br />- I : Nom du fichier Photo 1<br />- J : Nom du fichier Photo 2<br />- K : Nom du fichier Photo 3<br />- L : Nom du fichier PDF</p>
                            ...
                            <form method="post" action="adm_produits_import_recap.php" name="aj_doc" id="aj_doc" enctype="multipart/form-data">
