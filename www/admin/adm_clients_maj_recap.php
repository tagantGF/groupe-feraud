                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  <h1>Importation nouveau fichier client</h1>
						<?php
                        // Si le formulaire de creation a bien ete poste
                        $date 		= date('Y-m-d');
                        $heure 		= date('H:i:s');
                        if(isset($_POST['btnsuite']) and ($_FILES['ficcsv']['name'] != '') and (!isset($_POST['btnimport'])))
                        {
                            $nomfic = "clientbtf".rand().".csv";
                            // charge le fichier cible en base
                            $pdf = envoi_document($nomfic, $_FILES['ficcsv']['tmp_name'], "cible");
                            ...
                            <br />
                            <br />
                            <form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>?_fic=<?php echo $nomfic; ?>" name="aj_doc" id="aj_doc">
        
        
                                <input type="submit" id="btnimport" name="btnimport" value="Lancer l'import du fichier" />
