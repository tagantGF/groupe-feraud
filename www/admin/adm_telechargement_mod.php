                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  <h1>Modifier un téléchargement</h1>
                        	...
                        	{
								$id_tele = $_GET['id_t'];
								$lect_telechargement = "SELECT * FROM illi21_telechargement WHERE id_t = '$id_tele';";
								...
								if(isset($_POST['modifier'])){
									...
									if($letelechargement->typet == "d")
									{
										if($_FILES['document']['name'] != "")
										{
											...
											$document = $letelechargement->fic_ou_lien;
										}
									
									}else{
										$document = $codeyou = securiseFormulaire($_POST['codeyou']);
									}
									$enr_documents = "update illi21_telechargement set titre = '$titre', fic_ou_lien = '$document', ordre = '$numord' WHERE id_t = '$id_tele' limit 1;";
									$res_enr_documents = mysqli_query($lien,$enr_documents) or die ("Erreur");
									?>		
									<p>Le téléchargement a bien été modifié.</p>
									<p><a href="adm_telechargement.php" class="gras">Retour à la gestion des téléchargements</a></p>
									<?php	
								}else{
									...
									<form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post" enctype="multipart/form-data" name="aj_coul" id="aj_coul">
                                        <div class="mb-3 mt-4 row">
                                            ...
                                            <div class="col-sm-9">
												<input type="text" name="titre" id="titre" class="form-control" value="<?php echo $letelechargement->titre ; ?>"   required/>
											</div>
                                        </div>
                                        <?php 
                                        if($letelechargement->typet == "d")
                                            {
                                            ?>
                                            <div class="mb-3 mt-4 row" id="docpdf">
                                                <label for="document" class="col-sm-3 col-form-label">Document PDF : </label>
                                                <div class="col-sm-9">
	                                                <input type="file" name="document" id="document" class="form-control"   /> (Taille maximale : 2 Mo)
                                                </div>
                                            </div>
                                            <?php
                                                if(is_file("../documents/".$letelechargement->fic_ou_lien))
                                            ...
                                            ?>
                                            <div class="mb-3 mt-4 row" id="docvid">
                                                <label for="document" class="col-sm-3 col-form-label">Code youtube : </label>
												<div class="col-sm-9">
    	                                            
                                                    <input type="text" name="codeyou" class="form-control" id="codeyou" maxlength="24"  required value="<?php echo $letelechargement->fic_ou_lien ; ?>" /> (Exemple : <b>ruI8pVuz_DM</b> issu du code https://youtu.be/<u>ruI8pVuz_DM</u> )
                                                </div>
                                            </div> 
                                            <?php
                                        ...
                                        <div class="mb-3 mt-4 row">
                                            <label for="document" class="col-sm-3 col-form-label">Ordre : </label>
                                            <div class="col-sm-9">
	                                            <input type="text" name="numord" id="numord" class="form-control"  value="<?php echo $letelechargement->ordre ; ?>"/>
                                            </div>
                                        </div>
                            ...
                            echo "Telechargement inexistant";
                        }
                            ?>
