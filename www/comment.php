...
<title>Feraud Color- Passez votre commande de peinture en ligne</title>
<meta name="Description" content="Avec Feraud Color, suivant le support à peindre, la peinture, lasure et vernis de qualité professionnelle et couleurs au choix sont à votre portée." />
<!-- InstanceEndEditable -->
...
<div class="super_container">
	...
	<div class="pages_internes">
        <div class="container">
        	<div class="row">
            	<div class="col"><h1>Passer votre commande sur feraud-color.fr est tr&egrave;s simple !</h1></div>
            </div>
            <div class="row">
            	<div class="col-6 picto">
                	<?php
					//Lecture de la page
					$lect_page = "SELECT * FROM illi21_pages WHERE nom_page = 'comment';";
                ...
                <div class="col-6">
                	<img src="img-yan/pinceau-dans-la-main-d-un-ouvrier.jpg" alt="" width="100%"/>
                </div>
            </div>
        </div>
	</div>
