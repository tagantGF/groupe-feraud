                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  <?php
							if(isset($_GET['_ida']) && is_numeric($_GET['_ida'])){
								...
								$lect_chantier = "SELECT * FROM illi21_actualites WHERE id_actu = '$id_actu';";
								$res_lect_chantier = mysqli_query($lien,$lect_chantier) or die ("Erreur lecture chantier");
								$chantier = mysqli_fetch_object($res_lect_chantier);
								?>
								<p align="center">Le diaporama photo de <strong><?php echo $chantier->titre; ?></strong></p>
								...
								if(isset($_POST['ajouter'])){
									if($_FILES['photo1']['name'] != ""){
										...
										$extension = substr(strrchr($_FILES['photo1']['name'], '.')  ,1);
										if(in_array($extension,$extensions_valides)){
											$legende = @securiseFormulaire($_POST['legende']);
											$ordre = @securiseFormulaire($_POST['ordre']);
											
											$photo1 = envoyerImage(($_FILES['photo1']['name']), $_FILES['photo1']['tmp_name'], "../images/actualites");	
											
											$enr_photo = "INSERT INTO illi21_actualites_photos (id_actu, ordre_photo, legende_photo, nm_photo) VALUES ('$id_actu', '$ordre', '$legende', '$photo1');";
											$res_enr_photo = mysqli_query($lien,$enr_photo) or die ("Erreur enregistrement photo");
										}
									}
								}
								...
								<form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" name="aj_prod" id="aj_prod" enctype="multipart/form-data" class="bordure">
									
                                    <div class="mb-3 mt-4 row">
                                    	<div class="col-12">
	                                        <center><strong>Ajouter une photo</strong></center>
                                        </div>
                                    </div>
									<div class="mb-3 mt-4 row">
                                        <label for="libelle" class="col-sm-2 col-form-label">Ordre* : </label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="ordre" id="ordre" maxlength="3" width="3" required placeholder="Ordre de classement" />
                                        </div>
                                    </div>
									...
									<div class="mb-3 mt-4 row">
                                        <label for="libelle" class="col-sm-2 col-form-label">Photo * : </label>
                                        <div class="col-sm-6">
									...
									<p><input type="submit" name="ajouter" id="ajouter" value="Ajouter la photo" /></p>
								</form>
								<?php
									...
									<div class="ligne-admin">
										<div class="libelle">
											<?php 
												echo $photo->ordre_photo."&nbsp; <img src=\"../images/actualites/".$photo->nm_photo."\" height=\"30px;\" />"; 
											?>
										</div>
										<div class="actions">
											<a href="adm-photos-mod.php?id_s=<?php echo $photo->id_photo; ?>&_ida=<?php echo $id_actu; ?>"><img src="images/administration/picto-modifier.png" height="25" /></a>
											<a href="adm-photos-sup.php?id_s=<?php echo $photo->id_photo; ?>&_ida=<?php echo $id_actu; ?>"><img src="images/administration/picto-supprimer.png" height="25" /></a>
										</div>
									</div>
									<div class="clear"></div>
									<?php	
							   ...
							   ?>
								<p class="centre"><a href="adm_blog.php">Retour à la liste des actualités</a></p>
								<?php
							}else{
								 echo "Actualité inexistante";
							}
							?>
