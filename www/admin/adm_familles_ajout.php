                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  <h1>Familles - Ajout</h1>
        	                ...
        	                if(isset($_POST['valider'])){
                                ...
                                $enr_famille = "INSERT INTO illi21_familles (id_famille, f_libelle, f_ordre, f_enligne, nomlien) VALUES ('', '$nomfamille', '$ordre', '$enligne', '$lienseo');";
                                $res_enr_famille = mysqli_query($lien, $enr_famille) or die ("Erreur : familles");
            		            ?>
                    		    <p>La famille a bien &eacute;t&eacute; enregistr&eacute;e.</p>
                            
                        		<p><a href="adm_familles_ajout.php" class="lien1">En ajouter une autre</a></p>		
                        ...
                        ?>
                            <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" name="aj_famille" id="aj_famille">
                                ...
                                <div class="mb-3 mt-4 row">
                                    ...
                                    <div class="col-sm-9">
	                                    <input type="text" name="nomfamille" id="nomfamille" class="form-control" required/>
                                    </div>
                                </div>
                                <div class="mb-3 mt-4 row">
                                 ...
                                 <div class="mb-3 mt-4 row">
                                    ...
                                    <div class="col-sm-9">
	                                    <input type="text" name="lienseo" id="lienseo" class="form-control" placeholder="Exemple : huiles-pour-parquets (pas d'espace et pas de caractères spéciaux)" maxlength="20"/>
                                    </div>
                                ...
                                <div class="mb-3 mt-4 row">   
                                	<div class="col-sm-9">   
                                    <input type="submit" name="valider" id="valider" value="Ajouter la famille" class="btn btn-success" />
                                    </div>
                                </div>
                            </form>
                        <?php
