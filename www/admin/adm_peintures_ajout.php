						  ...
						  <h1>Ajouter une couleur</h1>
							...
							if(isset($_GET['_idnu']) && is_numeric($_GET['_idnu'])){
								...
								if(isset($_POST['ajouter'])){
									...
									$enr_coule  = "INSERT INTO illi21_couleur (coul_com, coul_rvb, id_nuancier, tartype) ";
									$enr_coule .= "VALUES ('$coulnom', '$coulrvb', '$id_nuancier', '$typetar');";
									$res_enr_coule = mysqli_query($lien,$enr_coule) or die ("Erreur enregistrement couleur");
									?>		
									<p>La couleur a bien été ajoutée.</p>
									...
									<form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" name="aj_coul" id="aj_coul">
										<div class="mb-3 mt-4 row">
                                            ...
                                            <div class="col-sm-9">
												<input type="text" name="coulnom" id="coulnom" size="30" maxlength="48" required /> (48 caractères maxi. Exemple : RAL1000)
                                            </div>
										</div>
										...
										<div class="mb-3 mt-4 row">
                                            ...
                                            <div class="col-sm-9">
												<input type="text" name="coulrvb" id="coulrvb" size="30" maxlength="7" required /> (7 caractères maxi. Exemple : #BEBD7F)
                                            </div>
										</div>
										<div class="mb-3 mt-4 row">
                                            ...
                                            <div class="col-sm-9">
                                            	<div class="form-check">
                                                  <input class="form-check-input" type="radio" name="typetar" id="typetar1" value="100">
                                                  <label class="form-check-label" for="typetar1">
                                                    En stock
                                                  </label>
                                                </div>
                                                <div class="form-check">
                                                  <input class="form-check-input" type="radio" name="typetar" id="typetar2" value="200" checked>
										...
										<div class="mb-3 mt-4 row">   
                                            <div class="col-sm-9">   
                                            <input type="submit" name="ajouter" id="ajouter" value="Ajouter cette couleur" class="btn btn-success" />
                                            </div>
                                        </div>
									</form>  
									<?php
