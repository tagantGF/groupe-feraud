                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  <h1 class="txt17_1">Sous-Familles - Gestion</h1>
							<p><a href="adm_sous_familles_ajout.php" class="lien1 gras">Ajouter une sous-famille</a></p>
                            
                            <?php
                                //On lit les gammes existantes
                                $lect_familles = "SELECT * FROM illi21_familles ORDER BY f_ordre ASC;";
                                $res_lect_familles = mysqli_query($lien,$lect_familles) or die ("Erreur : lecture base famille");
                                while($familles = mysqli_fetch_object($res_lect_familles))
								{
									echo "<div class='ligne-titre'><strong>".(strtoupper($familles->f_libelle))."</strong></div>";
									$lect_sfamilles = "SELECT * FROM illi21_familles_sous where sf_famille = '$familles->id_famille' ORDER BY sf_ordre ASC;";
                                    $res_lect_sfamilles = mysqli_query($lien,$lect_sfamilles) or die ("Erreur : lecture base sous famille");
									$row_cnt = mysqli_num_rows($res_lect_sfamilles);
									if($row_cnt > 0)
									{
	                                    while($sfamilles = mysqli_fetch_object($res_lect_sfamilles))
    	                                {
										?>
                                        <div class="ligne-admin">
                                            <div class="libelle">
                                             <?php 
											if($sfamilles->sf_enligne == "1") 
											{
											...
											?>
                                            <?php 
                                                echo "&nbsp;-&nbsp;<strong>".($sfamilles->sf_libelle)."</strong>";
											?>	
                                            </div>
                                            <div class="actions">
                                                <a href="adm_sous_familles_modif.php?sfamille=<?php echo $sfamilles->id_sous_famille; ?>" title="Modifier cette sous famille"><img src="images/administration/picto-modifier.png" height="25" /></a>
                                                <a href="adm_sous_familles_sup.php?sfamille=<?php echo $sfamilles->id_sous_famille; ?>" title="Supprimer cette sous famille"><img src="images/administration/picto-supprimer.png" height="25" /></a>
                                            </div>
                                        </div> 
            	                          <?php
                	                    }
										...
										?>
                                        <div class="ligne-admin">
                                            <div class="libelle"><i>&nbsp;&nbsp;&nbsp;-&nbsp;Pas de sous-famille...</i></div>
                                        </div>
                                        <?php
									}
                                }
