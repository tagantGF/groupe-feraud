                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  <h1>Gestion des pages statiques</h1>
                            ...
                            if (isset($_POST['valider'])) {
                                ...
                                $texte = securiseFormulaire($_POST['texte_page']);
                                        
                                $maj_page = "UPDATE illi21_pages SET titre_page = '$titre', texte_page = '$texte' WHERE nom_page = '$page';";
                                $res_maj_page = mysqli_query($lien,$maj_page) or die ("Erreur");	
                            ?>
                            <p>La page a bien été modifiée.</p>
                            <?php				
                            }else{
                            ?>
                            <form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" name="validpage" id="validpage">
                            <?php
                                $lect_contenu = "SELECT * FROM illi21_pages WHERE nom_page = '$page' ";
                                $resLect_contenu = mysqli_query($lien,$lect_contenu) or die ('Erreur lors de la lecture de la page');
                                $contenu = mysqli_fetch_object($resLect_contenu);
                            ?>
                                <p>
                                    Titre de la page :
                                    <input type="text" name="titre" id="titre" size="80" maxlength="250" value="<?php echo $contenu->titre_page; ?>" />
                                </p>
                                <p>
                                    Texte de la page : <br />
                                  <textarea name="texte_page" id="texte_page"><?php echo  $contenu->texte_page; ?></textarea>              
                                  <script>CKEDITOR.replace( 'texte_page', {height: 500, width:750});</script>
                                                
                                </p>
                                <p>&nbsp;</p>
                                <p class="centrer">
                                    <input type="submit" name="valider" id="valider" value="Valider la page" />
                                </p>
                            </form>
                            <?php
                            }
