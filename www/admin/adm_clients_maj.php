                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9">
                          <!-- InstanceBeginEditable name="EditRegion3" -->
						   <h1>Mettre à jour le fichier client</h1>
                    
					<p>La mise à jour du fichier client consiste à importer un nouveau fichier client qui remplacera l'ancien fichier</p>
                    <p><strong>Procédure : </strong></p>
                    <ul style="font-size:12px; margin-left:20px;">
                    	<li>Sélectionner votre fichier que vous aurez exporté au format 'CSV'</li>
                        <li>Vérifier le nombre de ligne</li>
                        <li>Importer le nouveau fichier</li>
                        <li>La réduction sera automatiquement de 20%</li>
                    </ul>
                    <p>&nbsp;</p>
                    <form method="post" action="adm_clients_maj_recap.php" name="aj_doc" id="aj_doc" enctype="multipart/form-data" style="background:#eeeeee; padding:1%; border-radius: 5px;">
                        <div class="mb-3 mt-4 row">
                            <label for="famille" class="col-sm-3 col-form-label">Fichier à importer* : </label>
                            <div class="col-sm-4"><input type="file" name="ficcsv" id="ficcsv" required /></div>
                        </div>
						<div class="mb-3 mt-4 row">
                        	<div class="col-12">
                            <center>
                        	<input type="submit" id="btnsuite" name="btnsuite" value="Charger le fichier" class="form-control btn btn-info col-4"/>
                            </center>
                            </div>
                        </div>
