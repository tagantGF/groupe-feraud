	...
	<div class="pages_internes">
		<div class="container">
			<div class="row">
                ...
                <div class="col-md-12">
	                <div class="row">
    	            	<div class="col-lg-2 gras">Date</div>
        	            <div class="col-lg-2 centre gras">Heure</div>
            	        <div class="col-lg-7 centre gras">Montant total</div>
                        <div class="col-lg-1 droit gras">Port</div>
                	</div>
                </div>
				<div class="col-md-12">
                	<?php  
						...
						$lect_cmd	= "SELECT * FROM illi21_commandes where id_client = '$id_user' and ( (c_paiement = '1') or (c_paymut = '1' and c_type_paiement= 'CB')) order by c_date desc, c_heure desc";
						// echo $lect_cmd;
						$res_lect_cmd = mysqli_query($lien ,$lect_cmd) or die ("Erreur 1");
						while($cmd = mysqli_fetch_object($res_lect_cmd))
						{
							...
							$heure		= $cmd->c_heure;
							$reduc		= $cmd->c_reduc;
							$total 		= number_format($cmd->c_total, 2, '.', '');
							$fport 		= $cmd->c_fdp;
							// $codpromo	= $cmd->c_codpro;
							// $promo		= $cmd-> c_tot_promo_ttc ;
							...
							if($cmd->c_paiement == '1')
								...
								?>
                                <div class="row" style="background:<?php echo $bg;?>; margin-top:5px;">
                                    <div class="col-lg-2 gras"><?php echo $datecmd[2]."/".$datecmd[1]."/".$datecmd[0]; ?></div>
                                    <div class="col-lg-2 centre gras"><?php echo $heure; ?></div>
                                    <div class="col-lg-7 centre gras">
										<?php 
											echo $total." €"; 
											if($reduc > 0 )
												{
													$reduc = number_format($reduc * ( (100 + $tauxtva[1]) / 100 ), 2, '.', ' ');
													echo "( Dont réduction : ".$reduc." €)"; 
												}
										?></div>
                                    <div class="col-lg-1 droit gras" style="text-align:right;"><?php echo $fport; ?> €</div>
                                </div>
                                <?php
								...
								while($ligne_cmd = mysqli_fetch_object($res_lect_det_cmd))
								{
									if($ligne_cmd->d_produit == "")
									{
										...
										$libelle = $lacouleur." - ".$couleur." ".$brillance." - ".$lesupport." - ".$lecontenant." - ".$lenuancier;
									}else{
										$libelle = $ligne_cmd->d_produit ;
									}
									...
									<tr>
										<td colspan="5">
											<table border="0" cellpadding="1" cellspacing="0" width="100%">
												<tr>
													<td width="6%">&nbsp; </td>
													<td width="70%"><?php echo $libelle ;?></td>
