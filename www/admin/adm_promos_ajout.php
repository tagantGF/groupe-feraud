    ...
    <?php 
            ...
            if(estAuthentifieClient())
            {
                ...
                if(isset($_POST['ajouter'])){
					...
					$cadeau		= securiseFormulaire($_POST['cadeau']);
                    ...
                    {
                        ?>		
                        <p>ATTENTION, ce code comporte une valeur en euro et un pourcentage, ajout impossible.</p>
                        <p><a href="adm_promos.php" class="gras">Retour à la gestion des codes</a></p>
                        <?php	
                    }else{
                        // verifie s un code identique n'existe pas déjà
                        $lect_code = "SELECT * FROM illi21_promo WHERE code_promo = '$libelle';";
                        $res_lect_code = mysqli_query($lien,$lect_code) or die ("Erreur ledture base promo");
                        if(mysqli_num_rows($res_lect_code))
                            {
                            ?>		
                            <p>ATTENTION, ce code existe déjà, ajout impossible.</p>
                            <p><a href="adm_promos.php" class="gras">Retour à la gestion des codes</a></p>
                            <?php
                            }else{
                                $enr_promo  = "INSERT INTO   illi21_promo (code_promo, promo_pourc , promo_mttc, cadeau, dtdebut, dtfin, actif) ";
                                $enr_promo .= "VALUES ('$libelle', '$pourcent', '$mttc', '$cadeau','$datedeb','$datefin', '$p_actif');";
                                $res_enr_promo = mysqli_query($lien,$enr_promo) or die ("Erreur enregistrement code promo");
                                ?>		
                                <p>Le code a bien été ajouté.</p>
                                <p><a href="adm_promos.php" class="gras">Retour à la gestion des codes</a></p>
                                <?php	
                            }
                    }
                    ...
                    <form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" name="aj_sfam" id="aj_sfam">
						<div class="mb-3 mt-4 row">
                        	...
                        	<div class="col-sm-4">
                            	<input type="text" class="form-control" name="libcode" id="libcode" size="20" maxlength="12" required placeholder="12 caractères maxi" />
                            </div>
                        </div>
                        <div class="mb-3 mt-12 row">
                        	<div class="col-12">Veuillez saisir soit un montant, soit un pourcentage, soit cocher la case cadeau</div>
                        </div>
                        <div class="mb-3 mt-12 row">
                        	<div class="col-1"></div>
                        	<label for="libelle" class="col-sm-3 col-form-label">Montant € sur HT: </label>
                        	<div class="col-sm-3">
                            	<input type="text" class="form-control"  name="mttc" id="mttc" size="4" maxlength="3" value="" />
                            </div>
                        </div>
                        ...
                        <div class="mb-3 mt-12 row">
                        	...
                        	<div class="col-sm-3">
                            	<input type="text" class="form-control"  name="pourcent" id="pourcent" size="4" maxlength="2" value="" />
                            </div>
                        </div>
                        ...
                        <div class="mb-3 mt-12 row">
                        	...
                        	<div class="col-sm-3">
                            	<input type="checkbox" class="form-control"  name="cadeau" id="cadeau"value="1" />
                            </div>
                        </div>
                        ...
                        <div class="mb-3 mt-4 row">
                            <label for="enligne" class="col-sm-2 col-form-label">Actif : </label>
                            <div class="col-sm-4">
                        ...
                        <div class="mb-3 mt-4 row">
                            <div class="col-sm-9">
                            <input type="submit" name="ajouter" id="ajouter" value="Ajouter le code" class="btn btn-success" />
                            </div>
                        </div>
                    </form>  
                    <?php
