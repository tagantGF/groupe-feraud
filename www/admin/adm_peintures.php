                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9">
                          <!-- InstanceBeginEditable name="EditRegion3" -->
							...
							<?php
                            $lect_nuanciers = "SELECT * FROM illi21_nuancier where id_n <> '99' ORDER BY nunom ASC;";
                            $res_lect_nuanciers = mysqli_query($lien,$lect_nuanciers) or die ("Erreur");
                            while($lenuancier = mysqli_fetch_object($res_lect_nuanciers)){
                            ?>
                            <div class="ligne-admin">
                                <div class="libelle"><?php echo ($lenuancier->nunom);?></div>
                                <div class="actions">
                                    <a href="adm_peintures_liste.php?_idnu=<?php echo $lenuancier->id_n; ?>"><img src="images/administration/picto-nuancier.png" width="25" /></a>
