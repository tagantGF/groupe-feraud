...
<title>Feraud Color- Spécialiste de la peinture qualité professionnelle</title>
<meta name="Description" content="Feraud Color expert de la peinture, lasure, vernis de qualité professionnelle avec coloration personnalisée et suivant nuanciers référencés." />
<!-- InstanceEndEditable -->
...
<div class="super_container">
	...
	<div class="pages_internes dynamiques">
        <div class="container">
        	<div class="row">
            	<div class="col-12">
            	<?php
				//Lecture de la page
				$lect_page = "SELECT * FROM illi21_pages WHERE nom_page = 'mentions';";
