						  ...
						  <h1>Supprimer un slide</h1>
                            ...
                            if(isset($_GET['id_s']) && is_numeric($_GET['id_s']))
                            {
                                ...
                                if(isset($_POST['supprimer'])){
                                    ...
                                    if(is_file("../images/slide/".$leslide->slideimg))
                                                unlink("../images/slide/".$leslide->slideimg);
                                    
                                    $sup_slide = "DELETE FROM illi21_slider WHERE id_sf = '$id_slide' limit 1;";
                                    $res_sup_slide = mysqli_query($lien,$sup_slide) or die ("Erreur suppression slide");
                                    ?>		
                                    <p>Le slide a bien été supprimé.</p>
                                    <p><a href="adm_slider.php" class="gras">Retour à la gestion des slides</a></p>
                                    <?php	
                                }else{
                                    ?>
                                    <form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" name="mod_sfam" id="mod_sfam">
                                        <div class="mb-3 mt-4 row">
                                        	<label for="photo2" class="col-sm-3 col-form-label">Slider à supprimer : </label>
                                            <div class="col-sm-9">
	                                            <strong><?php echo $leslide->nomslider; ?></strong>
                                            </div>
                                        </div>
                                        <div class="mb-3 mt-4 row">
                                        ...
                                        <div class="mb-3 mt-4 row">
                                            <label>&nbsp;</label>
                                            <input type="submit" name="supprimer" class="btn btn-success" id="supprimer" value="Confirmez la suppression de ce slide" />
                                        </div>
                                    </form>  
                                    <?php
                                }
