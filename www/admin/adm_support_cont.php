                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  ?>
							<h1>Les contenants du support "<?php echo ($nomsup);?>"</h1>
                        	<a href="adm_support_cont_aj.php?idsup=<?php echo $id_support;?>" class="btn btn-info mb-2">Ajouter un contenant à ce support</a>
							<?php
                            $lect_contenant = "SELECT * FROM illi21_rel_sup_conten where id_su = '$id_support' ORDER BY ordre_cont ASC;";
                            $res_lect_contenant = mysqli_query($lien,$lect_contenant) or die ("Erreur");
							if($row_cnt = mysqli_num_rows($res_lect_contenant) > 0)
							{
								while($lescontenant = mysqli_fetch_object($res_lect_contenant))
								{
									// Recherche nom du contenant
									$id_cont = $lescontenant->id_co;
									...
									$nomcont = $lecontenant->cont_nom;
									?>
									<div class="ligne-admin">
										<div class="libelle"><?php echo $lescontenant->ordre_cont." - ".$nomcont;?></div>
										<div class="actions">
											<a href="adm_support_cont_sup.php?_id_rl_sup_con=<?php echo $lescontenant->id_rl_sup_con; ?>"><img src="images/administration/picto-supprimer.png" width="25" /></a>
										</div>
									</div>
									<div class="clear"></div>
									<?php	
								...
								echo "<p>Aucun contenant actuellement ...</p>";
							}
                            ?>
