...
<title>Feraud Color- La peinture personnalisée est notre métier</title>
<meta name="Description" content="Feraud Color vous propose un vaste choix de couleurs selon nuanciers référencés, peinture, lasure et vernis de qualité professionnelle personnalisables." />
<!-- InstanceEndEditable -->
...
<div class="super_container">
	...
	<div class="pages_internes">
        <div class="container">
        	<div class="row">
            	<div class="col"><h1>Des experts Feraud Color vous accompagnent</h1></div>
            </div>
            <div class="row">
            	<div class="col-6">
                	<?php
					//Lecture de la page
					$lect_page = "SELECT * FROM illi21_pages WHERE nom_page = 'qui';";
					$res_lect_page = mysqli_query($lien,$lect_page) or die ("Erreur : page");
					$page = mysqli_fetch_object($res_lect_page);
					echo $page->texte_page; 
					?>
                    <!-- <iframe width="475" height="250"  src="https://www.youtube.com/embed/ruI8pVuz_DM" frameborder="0" allowfullscreen></iframe> -->
                
                </div>
                <div class="col-6">
                	<img src="img-yan/fotolia_106093524.jpg" alt="" width="100%"/>
                </div>
            </div>
        </div>
	</div>
