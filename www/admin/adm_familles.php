                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  <h1 class="txt17_1">Familles - Gestion</h1>
							
                            	<p><a href="adm_familles_ajout.php" class="lien1 gras">Ajouter une famille</a></p>
                            ...
                            <?php
							    ...
							    <div class="ligne-admin">
                                    ...
                                    &nbsp;&nbsp;&nbsp;
									<?php 
										echo "<strong>".$familles->f_ordre." - ".($familles->f_libelle)."</strong>";?>
				
									</div>
									<div class="actions">
	                                	<a href="adm_familles_modif.php?famille=<?php echo $familles->id_famille; ?>" title="Modifier cette famille"><img src="images/administration/picto-modifier.png" height="25" /></a>
										<a href="adm_familles_sup.php?famille=<?php echo $familles->id_famille; ?>" title="Supprimer cette famille"><img src="images/administration/picto-supprimer.png" height="25" /></a>
                                    </div>
                                </div> 
                            <?php
                                }
