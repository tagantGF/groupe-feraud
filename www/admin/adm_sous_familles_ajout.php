                            ...
                            <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" name="aj_famille" id="aj_famille">
                                ...
                                <div class="mb-3 mt-4 row">
                                 ...
                                 <div class="mb-3 mt-4 row">
                                    ...
                                    <div class="col-sm-10">
	                                    <input type="text" name="lienseo" id="lienseo" class="form-control" placeholder="Exemple : huiles-pour-parquets (pas d'espace et pas de caractères spéciaux)" maxlength="120"/>
                                    </div>
