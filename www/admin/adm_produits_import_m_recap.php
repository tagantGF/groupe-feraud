                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  <?php 
							...
							if(isset($_POST['btnsuite']) and ($_FILES['lecsv']['name'] != ''))
							{
								...
								if ($fichier) 
								{
									...
									while(!feof($fichier))
									{
										...
										if($i == '1')
										{
											...
											// print_r($element);
											$_p_id_prod		= mysqli_real_escape_string($lien,$element[0]);
											$_p_nom			= (mysqli_real_escape_string($lien,$element[1]));
											$_p_ref			= (mysqli_real_escape_string($lien,$element[2]));
											$_p_prix_ht		= mysqli_real_escape_string($lien,$element[3]);
											$_p_poids		= mysqli_real_escape_string($lien,$element[4]);
											$_p_enligne		= mysqli_real_escape_string($lien,$element[5]);
											$_p_ordre		= mysqli_real_escape_string($lien,$element[6]);
								...
								<br />
								<form method="post" action="adm_produits_import_m_recap.php?_fic=<?php echo $nomfic; ?>" name="aj_doc" id="aj_doc">
								...
								if ($fichier) 
								{
									while(!feof($fichier))
									{
										...
										if (1 == 1)
										{
											...
											$insertion  = "INSERT INTO `illi21_produits_var` (`id_prod`, `p_nom`, `p_ref`, `p_prix_ht`, `p_poids`, `p_enligne`, `p_ordre`) VALUES (";
											
											
											$insertion .= "'$_p_id_prod','$_p_nom','$_p_ref','$_p_prix_ht','$_p_poids','$_p_enligne','$_p_ordre');";
											// echo $insertion."<br>";
