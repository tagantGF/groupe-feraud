                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  <h1>Familles - Modification</h1>
                
							<?php
							$id_famille = $_GET['famille'];
							$lect_famille = "SELECT * FROM illi21_familles WHERE id_famille = '$id_famille';";
							$res_lect_famille = mysqli_query($lien,$lect_famille) or die ("Erreur : lecture famille");
							$famille = mysqli_fetch_object($res_lect_famille);
        	                if(isset($_POST['valider'])){
                               
                                $nomfamille = (securiseFormulaire($_POST['nomfamille']));
                                ...
                                $enr_famille = "UPDATE illi21_familles set f_libelle = '$nomfamille', f_ordre = '$ordre', f_enligne = '$enligne', nomlien = '$lienseo'  WHERE id_famille = '$id_famille' limit 1;";
                                $res_enr_famille = mysqli_query($lien, $enr_famille) or die ("Erreur : familles");
            		            ?>
                    		    <p>La famille a bien &eacute;t&eacute; modifi&eacute;e.</p>
                            
                        		<p><a href="adm_familles.php" class="lien1">&lt; Gestion des familles</a></p>
                        <?php		
                            }else{
                        ?>
                            <form method="post" action="<?php echo $_SERVER['PHP_SELF']."?famille=$id_famille"; ?>" name="aj_famille" id="aj_famille">

                                <div class="mb-3 mt-4 row">
                                    <label for="nomfamille" class="col-sm-3 col-form-label">Libellé : </label>
                                    <div class="col-sm-9">
	                                    <input type="text" name="nomfamille" id="nomfamille" class="form-control" value="<?php echo ($famille->f_libelle); ?>" required/>
                                    </div>
                                </div>
                                <div class="mb-3 mt-4 row">
                                    <label for="ordre" class="col-sm-3 col-form-label">Ordre : </label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" name="ordre" id="ordre" size="10" maxlength="3" value="<?php echo $famille->f_ordre; ?>" required/>
                                    </div>
                                 </div>
                                 <div class="mb-3 mt-4 row">
                                    <label for="enligne" class="col-sm-3 col-form-label">En ligne : </label>
                                    <div class="col-sm-3">
                                        <select name="enligne" id="enligne" class="form-control" required>
                                            <option value="1" <?php if($famille->f_enligne == '1') echo 'selected="selected"';?>>Oui</option>
                                            <option value="0" <?php if($famille->f_enligne == '0') echo 'selected="selected"';?>>Non</option>
                                        </select>
                                    </div>
                                 </div>
                                 <div class="mb-3 mt-4 row">
                                    <label for="nomfamille" class="col-sm-3 col-form-label">Lien SEO : </label>
                                    <div class="col-sm-9">
	                                    <input type="text" name="lienseo" id="lienseo" class="form-control" maxlength="20" value="<?php echo $famille->nomlien; ?>"/>
                                    </div>
                                ...
                                <div class="mb-3 mt-4 row">   
                                	<div class="col-sm-9">   
                                    <input type="submit" name="valider" id="valider" value="Modifier la famille" class="btn btn-success" />
                                    </div>
                                </div>
                            </form>
                        <?php
