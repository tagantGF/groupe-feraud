                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  <h1>Tarif de base des peintures au litre</h1>
                          <?php
                          if(isset($_POST['modifier']))
						  {
							  $tar_classique 	= securiseFormulaire($_POST['tarclassique']);
							  $tar_mesure 		= securiseFormulaire($_POST['tarmesure']);
							  
							  if ($tar_classique > 0 and $tar_mesure > 0)
							  {
							  	$maj_tarif  = "UPDATE illi21_tarifs_peintures SET tarifs = '$tar_classique' WHERE id_tar = '100';"; // Classique 25.95
								$res_maj_tarif = mysqli_query($lien, $maj_tarif) or die ("Erreur modification tarifs de base");	
								$maj_tarif  = "UPDATE illi21_tarifs_peintures SET tarifs = '$tar_mesure' WHERE id_tar = '200';"; // sur mesure 27.95
								$res_maj_tarif = mysqli_query($lien, $maj_tarif) or die ("Erreur modification tarifs de base");	 
							  
							  	echo "<br>Les tarifs de base ont bien été modifiés ...<br>";
							  }else{
							  	echo "<br>Les tarifs de base n'ont pas été modifiés car l'un des nombre était à 0 ...<br>";
							  }
                          }else{
						  ?>
						  	<form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" name="recgesprod" id="recgesprod">
                                <div class="mb-3 mt-4 row">
                               		<label for="staticEmail" class="col-sm-4 col-form-label">Peintures en stock (€ HT)</label>
                                	<div class="col-sm-2">
		                                <input type="text" class="form-control" name="tarclassique" id="inputclassique" value="<?php echo $tarcla; ?>"  >
        	                        </div>
                                </div>
            
                                <div class="mb-3 row">
            	                    <label for="inputPassword" class="col-sm-4 col-form-label">Peintures sur mesure (€ HT)</label>
                	                <div class="col-sm-2">
                    		            <input type="text" class="form-control" id="inputmesure"  name="tarmesure" value="<?php echo $tarmes; ?>">
                            	    </div>
                                </div>
                                <div class="mb-3 row">
