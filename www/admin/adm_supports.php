                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9">
						  ...
						  <h1>Les supports</h1>
							...
							<?php
                            $lect_support = "SELECT * FROM illi21_support ORDER BY sup_ordre ASC;";
                            $res_lect_support = mysqli_query($lien,$lect_support) or die ("Erreur");
                            while($lesupport = mysqli_fetch_object($res_lect_support)){
                            ?>
                            <div class="ligne-admin">
                                <div class="libelle"><?php echo $lesupport->sup_ordre." - ".($lesupport->sup_nom);?></div>
                                <div class="actions">
                                	<a href="adm_support_cont.php?idct=<?php echo $lesupport->id_s; ?>"><img src="images/administration/picto-contenant.png" width="25" /></a>
                                    <a href="adm_support_mod.php?idct=<?php echo $lesupport->id_s; ?>"><img src="images/administration/picto-modifier.png" width="25" /></a>
                                </div>
                            </div>
                            <div class="clear"></div>
                            <?php	
